...
public class ShortestPathDijkstrasAlgo {
    ...
    private static void printShortestPath(int[] parent) {
    ...
    public static void main(String[] args) {
        ...
        ShortestPathDijkstrasAlgo obj = new ShortestPathDijkstrasAlgo();
        int[] res= obj.dijkstra(V,adj,S);

        printShortestPath(res);
